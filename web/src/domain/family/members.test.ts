...
const parental: MemberDraft = { name: 'Alex', role: 'editor', active: true }
...
describe('family membership', () => {
  ...
  it('renames a member without replacing their identity or outcomes', () => {
    ...
    const updated = saveFamilyMember(family, events, '2026-09-08', 'parent', { ...parental, name: 'Alexandra' }, 'adult', true)
  ...
  it('deactivates prospectively at daily and weekly boundaries while preserving pending changes', () => {
    ...
    const updated = saveFamilyMember(edited, events, '2026-09-09', 'parent', { ...parental, active: false }, 'adult', true)
    ...
    const restored = saveFamilyMember(updated, events, '2026-09-09', 'parent', parental, 'adult', true)
  ...
  it('allows an administrator handoff', () => {
    const updated = saveFamilyMember(family, [], '2026-09-07', 'parent', { ...parental, role: 'administrator' }, 'adult', true)
  ...
  it('handles deactivation before a future one-person activity starts', () => {
    ...
    const updated = saveFamilyMember(future, [], '2026-09-07', 'parent', { ...parental, active: false }, 'adult', true)
  ...
  it.each(['adult', 'child', 'missing', null])('rejects family edits by %s', (actor) => {
    expect(() => saveFamilyMember(family, [], '2026-09-07', actor, parental, 'adult', true)).toThrow('Only an administrator')
  })
})
